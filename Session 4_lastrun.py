...
expName = 'Session 4'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/apple/Documents/PSY310/data/Session 4_lastrun.py',
