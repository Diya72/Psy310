...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/apple/Documents/PSY310/6. Intentional Binding Experiment/untitled_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    display_text = visual.TextStim(win=win, name='display_text',
        text='Report the delay bdetween the key press and the beep sound (0-1000); Click submit after entering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=33.0, method='random', 
        ...
        trialList=data.importConditions('Untitled spreadsheet.xlsx'),
    ...
    for thisTrial in trials:
        ...
        button.reset()
        # keep track of which components have finished
        responseComponents = [display_text, textbox, button]
